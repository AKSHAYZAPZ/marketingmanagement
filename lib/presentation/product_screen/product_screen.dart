        ...
        child: Column(
          children: [
                                      ...
                                      children: [
                                        Container(
                                          ...
                                          decoration: BoxDecoration(
                                              border: firstIndex==index?Border.all(
                                                color: Colors.red, // Border color
                                                width: 2.0, // Border width
                                              ):Border.all(color: Colors.transparent),
                                            image: DecorationImage(
                                              fit: BoxFit.cover,
                                                image: NetworkImage(products!.data[index].categoryImage)),
                                        ...
                                        Text(products!.data[index].categoryName,
                                            overflow: TextOverflow.ellipsis,
                                            maxLines: 1,
                                            style:
                                                AppStyle.txtDMSansBold14Gray700)
                                      ],
                                    ),
                                  ),
                                ),
            ...
            Container(
              child: Expanded(
                child: ListView.builder(
                  itemCount: products!.data[firstIndex].productDetails.length,
                            ...
                            children: [
                              ...
                              TableRow(
                                ...
                                children: [
                                  ...
                                  Padding(
                                    padding: const EdgeInsets.all(8.0),
                                    child: Text(products!.data[firstIndex].productDetails[childIndex].productCode,
                                    maxLines: 2,
                                    overflow: TextOverflow.ellipsis,),
                                  ...
                                  Padding(
                                    padding: const EdgeInsets.all(8.0),
                                    child: Text(products!.data[firstIndex].productDetails[childIndex].productName,
                                        maxLines: 2,
                                        overflow: TextOverflow.ellipsis),
                                  ),
                                  Padding(
                                    padding: const EdgeInsets.all(8.0),
                                    child: Text(products!.data[firstIndex].productDetails[childIndex].sellingPrice,
                                        maxLines: 2,
                                        overflow: TextOverflow.ellipsis),
                                  ),
                                  Padding(
