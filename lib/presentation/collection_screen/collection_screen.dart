...
class _CollectionScreenState extends State<CollectionScreen> {
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      onWillPop: ()async {
       Get.to(BottomNavigationScreen(id: widget.id));
        // Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => HomeDashboardScreen(id: widget.id),));
        return false;
      },
      child: Scaffold(
                        ...
                        Container(
                          child: Expanded(
                            child: ListView.builder(
                              itemCount:
                                  collection!.data.collectionReport.length,
